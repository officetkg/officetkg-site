...
FURNITURE = {
    ...
    "WORK_DESK_1":  {"box": rect(418, 420, 471, 526), "size_mm": (700, 1400),
                     "note": "worktop against the west wall, user faces west"},
    "WORK_DESK_2":  {"box": rect(418, 530, 471, 636), "size_mm": (700, 1400),
                     "note": "in line with DESK_1, continuous 2.8 m run"},
    ...
    "PRINTER_UNIT": {"box": rect(517, 410, 555, 444), "size_mm": (500, 450),
                     "note": "small printer on a low unit, in the NE nook of the "
                             "bedroom zone, against the storage-wall pocket stub"},

    # ------------------------------------------------ Living Dining zone
    "MEETING_TABLE":   {"box": rect(562, 650, 698, 718), "size_mm": (1800, 900),
                        "note": "long axis EAST-WEST, east end faces the monitor wall; "
    ...
    "MONITOR_55":   {"box": rect(754, 637, 758, 730), "size_mm": (1230, 55),
                     "note": "55 inch 16:9, wall mounted on the EAST wall, "
                             "screen centre aligned with the meeting table axis"},
}

SEAT_ROWS = {"north": ["MEETING_CHAIR_1","MEETING_CHAIR_2","MEETING_CHAIR_3"],
             "south": ["MEETING_CHAIR_4","MEETING_CHAIR_5","MEETING_CHAIR_6"]}

# ----------------------------------------------------------------------
# circulation / clearance routes that must stay open (work px)
# ----------------------------------------------------------------------
CLEARANCES = {
    "entrance -> LD, door swing":      {"zone": rect(632, 408, 758, 500), "min_mm": 800},
    "LD north open area":              {"zone": rect(562, 408, 758, 605), "min_mm": 1200},
    "east aisle, LD -> south zone":    {"zone": rect(698, 408, 758, 764), "min_mm": 750},
    "MB <-> LD, east partition gap":   {"zone": rect(556, 485, 572, 605), "min_mm": 600},
    "MB <-> south zone, south gap":    {"zone": rect(466, 636, 557, 660), "min_mm": 900},
    "work chair 1 pull-out":           {"zone": rect(471, 448, 700, 497), "min_mm": 900},
    "work chair 2 pull-out":           {"zone": rect(471, 558, 700, 605), "min_mm": 900},
    "meeting chair pull-out, north":   {"zone": rect(562, 560, 698, 605), "min_mm": 550},
    "meeting chair pull-out, south":   {"zone": rect(562, 763, 698, 816), "min_mm": 550},
    ...
    "south zone, west of meeting":     {"zone": rect(440, 652, 562, 816), "min_mm": 900},
